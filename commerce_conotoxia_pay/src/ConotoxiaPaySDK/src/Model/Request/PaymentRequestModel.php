...
class PaymentRequestModel implements RequestModelInterface
{
    ...
    /**
     * @var PaymentOrderRequestModel|null
     */
    protected $order;
    ...
    /**
     * @return PaymentOrderRequestModel|null
     */
    public function getOrder(): ?PaymentOrderRequestModel
    {
        return $this->order;
    }

    /**
     * @param PaymentOrderRequestModel $order
     *
     * @return PaymentRequestModel
     */
    public function setOrder(PaymentOrderRequestModel $order): PaymentRequestModel
    {
        $this->order = $order;
