...
class RefundManager extends BaseService implements RefundManagerInterface
{
    ...
    /**
     * Decodes received refund notification response and returns refund status.
     *
     * Example:
     *     $this->getRefundStatus(\file_get_contents("php://input"));
     *
     * @param string $input
     *
     * @return StatusInterface
     */
    public function getRefundStatus(string $input): StatusInterface
    {
        $verifier = $this->dependencyFactory->createRefundVerifier(
